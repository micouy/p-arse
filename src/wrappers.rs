...
#[derive(Copy, Clone)]
pub struct NegativePredicate<'a, P>
where
    P: Parser<'a>,
{
    pub(crate) parser: P,
...
impl<'a, P> Parser<'a> for NegativePredicate<'a, P>
where
    P: Parser<'a>,
{
    type Output = ();
...
#[derive(Copy, Clone)]
pub struct PositivePredicate<'a, P>
where
    P: Parser<'a>,
{
    pub(crate) parser: P,
...
impl<'a, P> Parser<'a> for PositivePredicate<'a, P>
where
    P: Parser<'a>,
{
    type Output = ();
